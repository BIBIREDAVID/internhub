...
const styles = {
  ...
  column: { background: theme.surface, border: `1px solid ${theme.border}`, borderRadius: "14px", padding: "16px" },
  ...
  card: { background: theme.bg, border: `1px solid ${theme.border}`, borderRadius: "12px", padding: "12px" },
  ...
  tag: { padding: "4px 8px", borderRadius: "999px", background: theme.border, color: theme.muted, fontSize: "11px" },
