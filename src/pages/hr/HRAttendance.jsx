...
const styles = {
  ...
  commentBox: { marginTop: "10px", background: theme.surfaceAlt, border: `1px solid ${theme.border}`, borderRadius: "10px", padding: "12px" },
  commentLabel: { color: theme.muted, fontSize: "12px", marginBottom: "4px" },
  commentText: { color: theme.text, fontSize: "13px", lineHeight: 1.5 },
