...
const styles = {
  ...
  progressLabel: { color: theme.muted, fontSize: "12px", marginBottom: "6px" },
  barWrap: { height: "8px", background: theme.border, borderRadius: "999px", overflow: "hidden" },
  barFill: { height: "100%", background: theme.primary, borderRadius: "999px" },
  progressText: { color: theme.muted, fontSize: "12px", marginTop: "6px" },
